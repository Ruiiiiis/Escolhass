...
const characters: CharacterCardData[] = [
  ...
  },
  {
    ...
    abilityBullets: [
      ...
      "Narrativa — Medo de Elora: adapte criativamente os Efeitos de Medo para manifestações mais psicóticas e perturbadoras, conforme a ficção e a critério da jogadora/Mestre.",
    ],
    traits: [
...
function CharacterCard({ data }: { data: CharacterCardData }) {
  ...
  return (
    <Card className="relative w-[720px] max-w-full rounded-2xl shadow-2xl border-slate-800 bg-slate-950/70 backdrop-blur">
      {/* Ornamento de fundo */}
        ...
        <div className="flex items-start gap-4">
          <div className="grid gap-1">
            <div className="flex items-center gap-3">
              <CardTitle className="text-3xl md:text-4xl font-bold tracking-tight text-slate-100">
                {hasHidden && hidden ? "???" : name}
              </CardTitle>
              {hasHidden && (
                <Button
                  variant="ghost"
